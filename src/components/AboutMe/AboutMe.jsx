...
const AboutMe = () => {
  return (
    <section className="aboutme section">
      ...
      <hr className="row aboutme__row"></hr>
      <figure className="aboutme__image-container">
        <img src={imagepath} alt="Фотография студента" className="aboutme__image"/>
      </figure>
      <h3 className="aboutme__name">Виталий</h3>
      <p className="section__description aboutme__info">Фронтенд-разработчик, 30 лет</p>
      <p className="section__description aboutme__description">Я родился и живу в Саратове, закончил факультет экономики СГУ.
